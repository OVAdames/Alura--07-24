        ...
        alternativas: [
            {
                ...
                afirmacao: "Acabou chamando atenção do homen desconhecido. E quando chapeuzinho encontra um lobo aonde sua avó deveria estar, ela tenta fugir, mas a porta já estava trancada.",
            },
            {
...
function respostaSelecionada(opcaoSelecionada){
    ...
    afirmacoes = afirmacoes.replace(/lobo/gi, '<span class="texto-preto">lobo</span>');
...
function mostraResultado() {
    ...
    let resultadoFinal = historiaFinal.replace(/lobo/gi, '<span class="texto-preto">lobo</span>');
